...
<html>
    ...
    <body>
        <div>
            ...
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=init" target="_blank">init</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=register" target="_blank">register</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=validPhone" target="_blank">validPhone</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=finishUserInfo" target="_blank">finishUserInfo</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=login" target="_blank">login</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=GetNearByYaoheInfo" target="_blank">GetNearByYaoheInfo</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=GetYaoheDetailsInfo" target="_blank">GetYaoheDetailsInfo</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=PublishYaohe" target="_blank">PublishYaohe</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=CommentYaohe" target="_blank">CommentYaohe</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=GoodYaohe" target="_blank">GoodYaohe</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=UngoodYaohe" target="_blank">UngoodYaohe</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=GetYaoheInfoByUser" target="_blank">GetYaoheInfoByUser</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=getUnreadCount" target="_blank">getUnreadCount</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=getUnreadMsg" target="_blank">getUnreadMsg</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=getAllFriends" target="_blank">getAllFriends</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=AddFriendsRequest" target="_blank">AddFriendsRequest</a>
            <a href="http://local.api.iyaohe.cc/ptest.php?m=ConfirmOrDenyFriendRequest" target="_blank">ConfirmOrDenyFriendRequest</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=ReadMsg" target="_blank">ReadMsg</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=UpdateFriendName" target="_blank">UpdateFriendName</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=DelFriend" target="_blank">DelFriend</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=AddQuestion" target="_blank">AddQuestion</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=LoginOut" target="_blank">LoginOut</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=ChangeLoginStatus" target="_blank">ChangeLoginStatus</a>
            <a href="http://local.api.iyaohe.cc/ptestlocal.php?m=LocationTest" target="_blank">LocationTest</a>
            <br/>
            <br/>
        </div>
        <hr>
    ...
    <script>
        ...
        function init()
        {
            ...
            document.getElementById("addressuri").value = "http://local.api.iyaohe.cc/app/" + methodName;
            ...
            switch (methodName)
            {
                ...
                case "getnearbyyaoheinfo":
                    ...
                    document.getElementById("value1").value = "\"116.412\"";
                    document.getElementById("name2").value = "longitude";
                    document.getElementById("value2").value = "\"41.3\"";
                ...
                case "getyaohedetailsinfo":
                    ...
                    break;
                case "publishyaohe":
                    document.getElementById("name1").value = "yaoheInfo";
                    document.getElementById("value1").value = '{ "yaoheID":1, "context":"有谁搭车去燕郊？", "contact_tel":"18888888888", "ad_status":1, "longitude":"41.3","latitude":"116.412","radius":200,"type":1,"image_url":"","usersTo":[1,2,3] }';
                    document.getElementById("name2").value = "access_token";
                    document.getElementById("value2").value = "\"\"";
                    break;
                case "commentyaohe":
