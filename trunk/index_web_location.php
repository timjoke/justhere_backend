        ...
        <div class="navbar">
            <div class="navbar-inner">
                <ul class="nav pull-right">
                    <li>
                        <a href="javascript:changeview();" style="width: 60px;">切换视图</a>
                    </li>
                    <li>
                        <a href="javascript:refresh();" style="width: 60px;">清空数据</a>
                    </li>
                    <li>
                        <a href="javascript:startAnimation();" style="width: 60px;">回放轨迹</a>
                    </li>
                    <li>
                        <a href="javascript:stopAnimation();" style="width: 60px;">停止轨迹</a>
                    </li>
                    <li>
...
<!--                <a class="brand"><span class="first">恰好后台位置跟踪系统</span></a>-->
                <div id="searchDate">
                    <input type="text" class="margin5" style="width:120px;" placeholder="请输入开始日期" id="begin_time"/>
                    <input type="text" class="margin5" style="width:120px;" placeholder="请输入结束日期" id="end_time"/>   
                    <a class="btn" href="javascript:search();" style="width: 60px;margin-top: 0px;">查询</a>
                    <input type="text" class="margin5" style="width:120px;" placeholder="请输入回放速度" id="back_speed"/>
                </div>
            </div>
        </div>
...
<!--                <span class="status"></span>-->
        ...
        <script src="css/webjs/login_location.js"></script>
